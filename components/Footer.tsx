    ...
    <footer className="mt-16 sm:mt-24" role="contentinfo" aria-label="Site footer">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="text-center space-y-4">
          ...
          {/* Coordinates */}
          <p className="font-mono text-xs tracking-[0.2em] text-sage">
            45.10&deg;N, 123.98&deg;W
          </p>

          {/* Brand + Location */}
          <p className="font-mono text-xs tracking-[0.25em] text-plate-border uppercase">
          ...
          {/* Publisher line */}
          <p className="font-mono text-xs tracking-[0.2em] text-plate-border/70 uppercase pt-1">
            Published by Ghost Forest Press, Neskowin
          </p>

          {/* Colophon note */}
          <p className="font-serif text-xs italic text-sage/80 max-w-md mx-auto leading-relaxed pt-2">
